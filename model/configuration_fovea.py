...
class FoveaConfig(PretrainedConfig):
    ...
    Arguments:
        vocab_size (`int`, *optional*, defaults to 32128):
            Vocabulary size of the Fovea model. Defines the number of different tokens that can be represented by the
            `inputs_ids` passed when calling [`FoveaModel`].
        ...
        d_ff (`int`, *optional*, defaults to 2048):
            Size of the intermediate feed forward layer in each `FoveaBlock`.
        ...
        feed_forward_proj (`string`, *optional*, defaults to `"relu"`):
            ...
            `"gated-gelu"` feed forward projection. Original Fovea implementation uses `"gated-gelu"`.
        encoder_attention_type (`string`, *optional*, defaults to `"local"`):
            ...
            supported by Fovea implementation.
